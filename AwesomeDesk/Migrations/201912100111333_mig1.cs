    ...
    public partial class mig1 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CmP_Name = c.String(maxLength: 60),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TicketStates", t => t.TiH_TiTID, cascadeDelete: true)
                .ForeignKey("dbo.TicketTypes", t => t.TiH_TiSID, cascadeDelete: true)
                .Index(t => t.TiH_TiTID)
                .Index(t => t.TiH_TiSID);
                ...
                c => new
                    {
                        ...
                        TiP_Content = c.String(maxLength: 3000),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TicketHeaders", "TiH_TiSID", "dbo.TicketTypes");
            DropForeignKey("dbo.TicketHeaders", "TiH_TiTID", "dbo.TicketStates");
